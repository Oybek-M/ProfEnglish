...
- **Next up (not yet started as of this log entry):** showing the AI-generated lesson's full structure/plan as an upfront outline (vocab count, exercise count, roleplay character, final task) somewhere in the Dashboard or Lesson info block, to make the "AI generates a real personalized curriculum" story more visible — pending founder confirmation before implementing.
